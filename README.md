...
1999년 TV 애니메이션 기반의 **비공식 팬메이드 웹게임 v0.4**입니다. 반복 현상, 사건, 육성 수치와 진화 조건은 이 게임의 창작 설정입니다. 원작 이미지·음원 추출물을 사용하지 않았습니다.
...
- 전체 Pages 전송량 약 5.4MiB, 타이틀 초기 리소스 약 0.4MiB입니다. 원본 PNG와 사용하지 않는 전체 이미지 묶음을 초기 로딩하지 않습니다.
...
- 정지 일러스트와 CSS 연출을 사용하며 프레임 애니메이션·성우·배경음악은 없습니다.
